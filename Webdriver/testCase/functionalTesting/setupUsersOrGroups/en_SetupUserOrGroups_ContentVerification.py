...
# Before Test: Please delete user  'testtest@test.com', user group 'test123456' and 'test userGroup2123456'
    def test_en_setup_users_or_groups_content_verification(self):
        ...
        try: self.assertTrue(self.is_element_present(By.ID, "users_userDelete"+testUserGroupIdValue))
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertTrue(self.is_element_present(By.ID, "users_userOptions"+testUserGroupIdValue))
        except AssertionError as e: self.verificationErrors.append(str(e))
        ...
        try: self.assertTrue(self.is_element_present(By.ID, "userGroup_userGroupOptions"+testUserGroupIdValue))
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertTrue(self.is_element_present(By.ID, "userGroup_userGroupDelete"+testUserGroupIdValue))
        except AssertionError as e: self.verificationErrors.append(str(e))
