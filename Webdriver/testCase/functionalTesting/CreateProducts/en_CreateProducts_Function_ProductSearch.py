...
class EnCreateProductsFunctionProductSearch(unittest.TestCase):
    ...
    def test_en_create_products_function_product_search(self):
        ...
        try: self.assertIn(testProduct1, driver.find_element_by_id("productSpace").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertIn(testProduct2, driver.find_element_by_id("productSpace").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
...
#        except AssertionError as e: self.verificationErrors.append(str(e))
        ...
        for i in range(60):
            try:
                if testProduct1 == driver.find_element_by_xpath("//li[@id='products_product"+testProduct1IdValue+"']/div/div").text: break
            except: pass
            time.sleep(1)
        else: self.fail("time out")
        try: self.assertIn(testProduct1, driver.find_element_by_id("productSpace").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertNotIn(testProduct2, driver.find_element_by_id("productSpace").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertNotIn(testInvueProduct1, driver.find_element_by_id("productSpace").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertNotIn(testInvueProduct2, driver.find_element_by_id("productSpace").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
#        try: self.assertNotIn("invueacc1", driver.find_element_by_id("productSpace").text)
#        except AssertionError as e: self.verificationErrors.append(str(e))
#        try: self.assertNotIn("invueacc2", driver.find_element_by_id("productSpace").text)
#        except AssertionError as e: self.verificationErrors.append(str(e))
        ...
        try: self.assertNotIn(testProduct1, driver.find_element_by_id("productSpace").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertNotIn(testProduct2, driver.find_element_by_id("productSpace").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertIn(testInvueProduct1, driver.find_element_by_id("productSpace").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertIn(testInvueProduct2, driver.find_element_by_id("productSpace").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
