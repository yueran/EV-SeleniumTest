...
class EnUploadMediaContentVerification(unittest.TestCase):
    ...
    def test_en_upload_media_content_verification(self):
        ...
        try: self.assertTrue(self.is_element_present(By.ID, "media_medium"+TestMediaIdValue+"Options"))
        except AssertionError as e: self.verificationErrors.append(str(e))
        ...
        try: self.assertTrue(self.is_element_present(By.CSS_SELECTOR,"span.newMediaGroupButton.adder"))
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertTrue(self.is_element_present(By.ID, "mediaGroup_mediaGroupDelete"+TestMediaGroupIdValue))
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertTrue(self.is_element_present(By.ID, "mediaGroup_mediaGroup"+TestMediaGroupIdValue+"Options"))
        except AssertionError as e: self.verificationErrors.append(str(e))
        ...
        driver.find_element_by_xpath("//li[@id='mediaGroup_mediaGroup"+TestMediaGroupIdValue+"']"+"/div/span").click()
#        try: self.assertTrue(self.is_element_present(By.CSS_SELECTOR, uploadMediaMediaGroup_medium+" > div.mediaBg.itemContent > div.handle"))
#        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertTrue(self.is_element_present(By.ID, "mediaGroup_mediumDelete"+TestMediaIdValue))
        except AssertionError as e: self.verificationErrors.append(str(e))
#        try: self.assertTrue(self.is_element_present(By.CSS_SELECTOR, uploadMediaMediaGroup_medium+"> div.mediaBg.itemContent > div.blockText"))
#        except AssertionError as e: self.verificationErrors.append(str(e))
        ...
        try: self.assertTrue(self.is_element_present(By.ID, "media_mediumDelete"+TestMediaIdValue))
        except AssertionError as e: self.verificationErrors.append(str(e))
