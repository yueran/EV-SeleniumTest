...
class EnUploadMediaContentVerification(unittest.TestCase):
    ...
    def test_en_upload_media_content_verification(self):
        ...
        try: self.assertTrue(self.is_element_present(By.ID, "media_medium"+uploadMediaMediumID+"Options"))
        except AssertionError as e: self.verificationErrors.append(str(e))
        ...
        try: self.assertTrue(self.is_element_present(By.ID, "mediaGroup_mediaGroupDelete"+uploadMediaGroupID))
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertTrue(self.is_element_present(By.ID, "mediaGroup_mediaGroup"+uploadMediaGroupID+"Options"))
        except AssertionError as e: self.verificationErrors.append(str(e))
        ...
        driver.find_element_by_xpath("//li[@id='mediaGroup_mediaGroup"+uploadMediaGroupID+"']"+"/div/span").click()
...
#        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertTrue(self.is_element_present(By.ID, "mediaGroup_mediumDelete"+uploadMediaMediumID))
        except AssertionError as e: self.verificationErrors.append(str(e))
...
#        except AssertionError as e: self.verificationErrors.append(str(e))
        ...
        try: self.assertTrue(self.is_element_present(By.ID, "media_mediumDelete"+uploadMediaMediumID))
        except AssertionError as e: self.verificationErrors.append(str(e))
