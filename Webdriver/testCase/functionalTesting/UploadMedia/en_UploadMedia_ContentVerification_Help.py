...
class EnUploadMediaContentVerificationHelp(unittest.TestCase):
    ...
    def test_en_upload_media_content_verification_help(self):
        ...
        try: self.assertIn(uploadMediaHelpLine1, driver.find_element_by_id("helpBody").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertIn(uploadMediaHelpLine2, driver.find_element_by_id("helpBody").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertIn(uploadMediaHelpLine3, driver.find_element_by_id("helpBody").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
