...
class EnScheduleTemplatesContentVerification(unittest.TestCase):
    ...
    def test_en_schedule_templates_content_verification(self):
        ...
        try: self.assertTrue(self.is_element_present(By.ID, "scheduleCol_schedule"+modifyTmpIdValue+"Options"))
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertTrue(self.is_element_present(By.CSS_SELECTOR, "#scheduleCol_schedule"+modifyTmpIdValue+"> div.itemContent.templateBg > span.fold"))
        except AssertionError as e: self.verificationErrors.append(str(e))
