...
class EnAddPostsToDisplayHelpContent(unittest.TestCase):
    ...
    def test_en_add_posts_to_display_help_content(self):
        ...
        try: self.assertIn(addPostsToDisplayHelpLine1, driver.find_element_by_id("helpBody").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertIn(addPostsToDisplayHelpLine2, driver.find_element_by_id("helpBody").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
