...
class EnAddPostsToDisplayContentVerification(unittest.TestCase):
    ...
    def test_en_add_posts_to_display_content_verification(self):
        ...
        try: self.assertIn("Display", driver.find_element_by_class_name("displayContainer").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertIn("Identify Display", driver.find_element_by_class_name("displayContainer").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
