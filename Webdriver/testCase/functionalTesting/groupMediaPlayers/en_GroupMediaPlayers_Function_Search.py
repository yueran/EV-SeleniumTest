...
#        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertNotIn(groupMediaPlayersDeviceStore15, driver.find_element_by_class_name("storeGroupCol").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertNotIn(groupMediaPlayersDeviceStore16, driver.find_element_by_class_name("storeGroupCol").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertIn(companyTest, driver.find_element_by_class_name("storeGroupCol").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertIn(storeGroupTest, driver.find_element_by_class_name("storeGroupCol").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertIn(storeTest, driver.find_element_by_class_name("storeGroupCol").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
        #device:
...
#        except AssertionError as e: self.verificationErrors.append(str(e))
        ...
        try: self.assertNotIn(companyTest, driver.find_element_by_class_name("storeGroupCol").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertNotIn(storeGroupTest, driver.find_element_by_class_name("storeGroupCol").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertNotIn(storeTest, driver.find_element_by_class_name("storeGroupCol").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
        #Store:
