...
class EnAddProductsToPostsSearch(unittest.TestCase):
    ...
    def test_en_add_products_to_posts_search(self):
        ...
        try: self.assertIn(addProductsToPostsProduct1, driver.find_element_by_id("allProductsSelect").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertIn(addProductsToPostsProduct2, driver.find_element_by_id("allProductsSelect").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
        driver.find_element_by_id("filterText").send_keys("abcd")
        driver.find_element_by_css_selector("span.searchIcon").click()
        try: self.assertIn(addProductsToPostsProduct1, driver.find_element_by_id("allProductsSelect").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertNotIn(addProductsToPostsProduct2, driver.find_element_by_id("allProductsSelect").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
