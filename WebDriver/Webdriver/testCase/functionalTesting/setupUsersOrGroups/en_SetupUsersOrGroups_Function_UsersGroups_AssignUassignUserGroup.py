...
class EnSetupUsersOrGroupsFunctionAssignUassignUserGroup(unittest.TestCase):
    ...
    def test_en_setup_users_or_groups_function_assign_uassign_user_group(self):
        ...
        #except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertTrue(self.is_element_present(By.CSS_SELECTOR, "#hierarchy_store249 > div.itemContent.storeBg > div.blockText"))
        except AssertionError as e: self.verificationErrors.append(str(e))
        element = driver.find_element_by_xpath("//li[@id='userGroup_userGroup172']/div/div")
        target = driver.find_element_by_css_selector("#hierarchy_store249 > div.itemContent.storeBg > div.blockText")
