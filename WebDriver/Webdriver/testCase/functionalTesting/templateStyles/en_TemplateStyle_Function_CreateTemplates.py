...
class EnTemplateStyleFunctionCreateTemplates(unittest.TestCase):
    ...
    def test_en_template_style_function_create_templates(self):
        ...
        try: self.assertNotIn(u"CreateTmp", driver.find_element_by_id("templateSpace").text)
...
#reloading problem.
        ...
        try: self.assertIn(u"CreateTmp", driver.find_element_by_id("templateSpace").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
