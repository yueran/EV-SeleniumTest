...
class EnStoreHierarchyContentVerification(unittest.TestCase):
    ...
    def test_en_store_hierarchy_content_verification(self):
        ...
        try: self.assertTrue(self.is_element_present(By.XPATH, "//li[@id='hierarchy_company250']/div/div[2]"))
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertTrue(self.is_element_present(By.ID, "hierarchy_company250Options"))
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertTrue(self.is_element_present(By.CSS_SELECTOR, "div.handle"))
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertTrue(self.is_element_present(By.ID, "hierarchy_company40Duplicate"))
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertTrue(self.is_element_present(By.ID, "hierarchy_company40Remove"))
        except AssertionError as e: self.verificationErrors.append(str(e))
