...
class EnStoreHierarchyFunctionDuplication2(unittest.TestCase):
    def setUp(self):
        gb_setUp(self)
    
    def test_en_store_hierarchy_function_duplication2(self):
        driver = self.driver
        gb_login(self)
...
#Flexible
        ...
        driver.find_element_by_id("hierarchy_store283Duplicate").click()
        driver.find_element_by_id("hierarchy_store284Duplicate").click()
