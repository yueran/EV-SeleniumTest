...
class EnStoreHierarchyFunctionDragAndDrop(unittest.TestCase):
    ...
    def test_en_store_hierarchy_function_drag_and_drop(self):
        ...
        try: self.assertTrue(self.is_element_present(By.XPATH, "//li[@id='hierarchy_company151']/div/div"))
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertTrue(self.is_element_present(By.XPATH, "//li[@id='hierarchy_storeGroup154']/div/div"))
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertTrue(self.is_element_present(By.XPATH, "//li[@id='hierarchy_store153']/div/div"))
        except AssertionError as e: self.verificationErrors.append(str(e))
        ...
        try: self.assertTrue(self.is_element_present(By.XPATH, "//li[@id='hierarchy_storeGroup154']/div/div[2]"))
        except AssertionError as e: self.verificationErrors.append(str(e))
        # ERROR: Caught exception [ERROR: Unsupported command [dragAndDropToObject]]
        driver.refresh()
