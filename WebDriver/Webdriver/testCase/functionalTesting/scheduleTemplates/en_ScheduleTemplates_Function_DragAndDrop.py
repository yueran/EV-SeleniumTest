...
class EnScheduleTemplatesFunctionDragAndDrop(unittest.TestCase):
    ...
    def test_en_schedule_templates_function_drag_and_drop(self):
        ...
        # ERROR: Caught exception [ERROR: Unsupported command [isTextPresent]]
        try: self.assertTrue(self.is_element_present(By.CSS_SELECTOR, "#scheduleCol_schedule193 > div.itemContent.templateBg > div.handle"))
        except AssertionError as e: self.verificationErrors.append(str(e))
        ...
        driver.refresh()
        try: self.assertTrue(self.is_element_present(By.CSS_SELECTOR, "#scheduleContainersCol_container203_schedule193 > div.itemContent.templateBg > span.unassign"))
        except AssertionError as e: self.verificationErrors.append(str(e))
        driver.find_element_by_css_selector("#scheduleContainersCol_container203_schedule193 > div.itemContent.templateBg > span.unassign").click()
