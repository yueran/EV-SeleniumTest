...
class EnViewNetworkStatusFunctionSearch(unittest.TestCase):
	...
	def test_en_view_network_status_function_search(self):
		...
		#Search by category
		try: self.assertIn(u"test device 1 (store 15)", driver.find_element_by_class_name("mainContentDiv").text)
		except AssertionError as e: self.verificationErrors.append(str(e))
		try: self.assertIn(u"test device 1 (store 16)", driver.find_element_by_class_name("mainContentDiv").text)
		except AssertionError as e: self.verificationErrors.append(str(e))
		Select(driver.find_element_by_id("selectedFilterValue")).select_by_visible_text("Active")
		try: self.assertNotIn(u"test device 1 (store 15)", driver.find_element_by_class_name("mainContentDiv").text)
		except AssertionError as e: self.verificationErrors.append(str(e))
		try: self.assertNotIn(u"test device 1 (store 16)", driver.find_element_by_class_name("mainContentDiv").text)
		except AssertionError as e: self.verificationErrors.append(str(e))
